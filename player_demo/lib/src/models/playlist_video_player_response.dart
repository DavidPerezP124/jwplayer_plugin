...
class PlaylistVideoPlayerResponse {
  ...
  factory PlaylistVideoPlayerResponse.fromJson(String str) =>
      PlaylistVideoPlayerResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PlaylistVideoPlayerResponse.fromMap(Map<String, dynamic> json) =>
      PlaylistVideoPlayerResponse(
        title: json["title"] ?? "",
        ...
        playlist: json["playlist"] != null
            ? List<VideoInfo>.from(
                json["playlist"].map((x) => VideoInfo.fromMap(x)))
            : [],
...
class Variations {
  ...
  factory Variations.fromJson(String str) =>
      Variations.fromMap(json.decode(str));
