...
class PlaylistResponse {
  ...
  factory PlaylistResponse.fromJson(String str) =>
      PlaylistResponse.fromMap(json.decode(str));

  // String toJson() => json.encode(toMap());

  factory PlaylistResponse.fromMap(Map<String, dynamic> json) =>
      PlaylistResponse(
        page: json["page"],
        pageLength: json["page_length"],
        playlists: List<Playlist>.from(
            json["playlists"].map((x) => Playlist.fromMap(x))),
        total: json["total"],
      );
