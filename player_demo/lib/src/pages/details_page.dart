        ...
        children: [
          ...
          ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Text(video.title, style: textTheme.headline5, overflow: TextOverflow.ellipsis, maxLines: 2),
                Text('${_printDuration(Duration(seconds: video.duration))}', style: textTheme.subtitle2, overflow: TextOverflow.ellipsis, maxLines: 2),
